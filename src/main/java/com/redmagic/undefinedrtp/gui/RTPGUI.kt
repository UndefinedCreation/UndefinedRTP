...
class RTPGUI(val plugin: UndefinedRTP): UndefinedMenu("ʀᴀɴᴅᴏᴍ ᴛᴇʟᴇᴘᴏʀᴛ", menuSize = MenuSize.MINI) {
    ...
    init {
        ...
        event<PlayerMoveEvent> {
            ...
            player.sendTitle("", "${ChatColor.RED}ᴛᴇʟᴇᴘᴏʀᴛ ᴄᴀɴᴄᴇʟᴇᴅ")
        }
                ...
                sync {
                    ...
                    repeatingTask(20){
                        ...
                        if (teleporting.containsKey(player!!.uniqueId)){
                            ...
                            player!!.sendTitle("", "${ChatColor.GREEN} ᴛᴇʟᴇᴘᴏʀᴛɪɴɢ ɪɴ ${teleporting[player!!.uniqueId]} ѕᴇᴄᴏɴᴅѕ ")

                            var left = teleporting[player!!.uniqueId]!!
                            left--
                            if (left < 0){
                                teleporting.remove(player!!.uniqueId)
                                player!!.sendTitle("", "${ChatColor.GREEN}ᴛᴇʟᴇᴘᴏʀᴛᴇᴅ...")
